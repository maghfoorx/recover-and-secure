...
- [x] Optimize the existing Amaanat staff workflow for tablet use.
...
- [x] Add category filters to Amaanat list pages.
...
- [x] Replace current dashboard queries with aggregated operational queries.
